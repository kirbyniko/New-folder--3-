...
var init_cache_info = __esm({
  "api/cache-info.ts"() {
    ...
    init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
    init_performance2();
    onRequest5 = /* @__PURE__ */ __name(async (context2) => {
...
// ../.wrangler/tmp/bundle-cZCeoV/middleware-loader.entry.ts
init_functionsRoutes_0_7350416873415733();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();

// ../.wrangler/tmp/bundle-cZCeoV/middleware-insertion-facade.js
init_functionsRoutes_0_7350416873415733();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
