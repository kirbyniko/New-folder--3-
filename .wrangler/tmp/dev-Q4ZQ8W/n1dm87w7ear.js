...
// .wrangler/tmp/pages-8Ug0RT/functionsWorker-0.6825204905032412.mjs
...
async function onRequest8(context22) {
  const { request, env: env22 } = context22;
  const url = new URL(request.url);
  ...
  try {
    ...
    for (const event of events) {
      const { results: bills } = await env22.DB.prepare(`
        SELECT 
          b.bill_number as number,
          b.title,
          b.url,
...
// .wrangler/tmp/pages-8Ug0RT/n1dm87w7ear.js
...
// .wrangler/tmp/bundle-IiQOHb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-IiQOHb/middleware-loader.entry.ts
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=n1dm87w7ear.js.map
