...
import { onRequest as __api_scraper_configs_ts_onRequest } from "C:\\Users\\nikow\\New folder (3)\\functions\\api\\scraper-configs.ts"
import { onRequest as __api_scraper_templates_ts_onRequest } from "C:\\Users\\nikow\\New folder (3)\\functions\\api\\scraper-templates.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_scraper_configs_ts_onRequest],
    },
  {
      ...
      method: "",
      middlewares: [],
      modules: [__api_scraper_templates_ts_onRequest],
    },
  {
