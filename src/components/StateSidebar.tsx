...
const STATE_PROGRESS: StateProgress[] = [
  ...
  { code: 'ND', name: 'North Dakota', status: 'complete', notes: 'Committee meetings calendar' },
  ...
  { code: 'RI', name: 'Rhode Island', status: 'complete', notes: '2 commission meetings' },
  { code: 'SC', name: 'South Carolina', status: 'complete', notes: '2 upcoming meetings' },
  { code: 'SD', name: 'South Dakota', status: 'complete', notes: 'Session starts Jan 13, 2026' },
  ...
  { code: 'VT', name: 'Vermont', status: 'complete', notes: 'Session starts Jan 6, 2026' },
